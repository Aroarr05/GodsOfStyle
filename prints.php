...
<body>
    ...
    <div class="filtrar">
        ...
        <div class="buscador">
            <form action="prints.php" method="get">
                <div class="container_buscador">
                    ...
                    <select id="dimensiones" name="dimensiones" required>
                        ...
                        <option value="841x1189cm">841x1189cm</option>
                        <option value="420x594cm">420x594cm</option>
                    </select>
                </div>
    ...
    <u>
        <h1 class="h1productos">PRINTS</h1>
    </u>
    ...
    <div class="container-items">
        ...
        try {
            ...
            $dimensiones = isset($_GET['dimensiones']) ? $_GET['dimensiones'] : '';

            // Preparar la consulta SQL
            $sql = "CALL mostrar_prints(:nombre, :precio, :stock, :dimensiones)";
            ...
            $stmt->bindValue(':dimensiones', htmlspecialchars($dimensiones));
